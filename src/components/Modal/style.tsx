...
export const QRModalContainer = styled(Modal)<QRModalContainerProps>`
  ...
  background-color: ${(props: QRModalContainerProps) => props.backgroundColor ?? COLOR_LISTS.WHITE};
`;

export const QRModalContentContainer = styled(View)<QRModalContentContainerProps>`
  width: ${(props: QRModalContentContainerProps) => props.width ?? '50'}%;
  height: ${(props: QRModalContentContainerProps) => props.height ?? '50'}px;
  background-color: ${(props: QRModalContentContainerProps) => props.backgroundColor ?? COLOR_LISTS.WHITE};
